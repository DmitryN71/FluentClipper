...
- **Светлая и тёмная темы** в стиле Windows 11, цвет акцента на выбор (или как в Windows), чёткий
  интерфейс при любом масштабе экрана.
...
Скачивать и ставить новую версию или нет — решаете вы. История и настройки лежат на вашем компьютере:
