...
- **Несколько записей сразу** (Shift/Ctrl+щелчок): вставить вместе, удалить, отметить звездой,
  перетащить.
- **Перетаскивание** записи мышью в любое поле любой программы.
...
- **Светлая и тёмная темы** в стиле Windows 11, чёткий интерфейс при любом масштабе экрана.
...
Программа ничего не отправляет в интернет. История и настройки лежат на вашем компьютере:
`%APPDATA%\FluentClipper`. При удалении программа спросит, стирать ли их.
...
- Несколько записей вставляются вместе простым текстом, без оформления; картинки при этом
  пропускаются.
